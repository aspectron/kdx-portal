                    ...
                    <section>
                        ...
                        <div>
                            ...
                            <div style="max-width:400px;">
                                Current release: &nbsp; KDX 2.9.0 &nbsp; Kaspa 0.11.14 (master)<br/>&nbsp;<br/>
...
//            'kdx-dev-v1.2.0-darwin-x64.dmg' : 'DMG',
            ...
            '-kdx-v2.9.0-linux-x64.zip' : 'portable'
        }).map(([file, descr]) => {
            let disable = '';
            if(file.charAt(0) == '-') {
