...
//		this.bodyEl = document.body;
                    ...
                    <section>
                        ...
                        <div>
                            ...
                            <div style="max-width:400px;">
                                Current release: &nbsp; KDX 2.10.11 &nbsp; Kaspa 0.12.3 (master)<br/>&nbsp;<br/>
    ...
    renderFiles(){
        ...
        let contents = Object.entries({
            'kdx-v2.10.11-windows-x64.exe' : 'installer',
...
//            'kdx-dev-v1.2.0-windows-x64.zip' : 'portable',
            'kdx-v2.10.11-darwin-x64.dmg' : 'DMG',
...
//            'kdx-dev-v1.2.0-darwin-x64.dmg' : 'DMG',
            ...
            '-kdx-v2.10.11-linux-x64.zip' : 'portable'
        }).map(([file, descr]) => {
            let disable = '';
            if(file.charAt(0) == '-') {
