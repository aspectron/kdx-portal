...
//		this.bodyEl = document.body;
    ...
    render(){
        ...
        <flow-app-layout floating-drawer>
            <img slot="header" class="logo" src="resources/images/kaspa.png" />
                    ...
                    <section>
                        ...
                        <div>
                            ...
                            <div style="max-width:400px;">
                                Current release: &nbsp; KDX 2.12.10 &nbsp; Kaspa 0.12.15 (master)<br/>&nbsp;<br/>
    ...
    renderFiles(){
        ...
        let contents = Object.entries({
            'kdx-v2.12.10-windows-x64.exe' : 'installer',
...
//            'kdx-dev-v1.2.0-windows-x64.zip' : 'portable',
            'kdx-v2.12.10-macos-x64.dmg' : 'DMG',
...
//            'kdx-dev-v1.2.0-darwin-x64.dmg' : 'DMG',
            ...
            'kdx-v2.12.10-linux-x64.tar.gz' : 'portable'
        }).map(([file, descr]) => {
            let disable = '';
            if(file.charAt(0) == '-') {
